...
== Description ==
Sharedom provides the user with a flat design responsive sharing buttons for Facebook, Twitter and Google+ that share the current URL. The plugin is really simple and light-weight and comes with a shortcode with parameters to allow/disallow either of the Sharing options and can be used multiple times with different options.
